...
\section*{细胞骨架}
\begin{enumerate}
\item \textbf{stress fibers是哪一种cytoskeleton?}

\item \textbf{Contractile ring是哪一种cytoskeleton？}

\item \textbf{neutrophil的移动和shape的改变依靠的是哪一种cytoskeleton}

\item \textbf{请指出epithelial cells 的apical和basal}

\item \textbf{将FtsZ、MreB、ParM与Crescentin进行一一对应}

\item \textbf{g-actin的三种亚型以及其主要作用都是什么？}

\item \textbf{分辨nocodazole和Taxol的作用}

\item \textbf{cofilin和capZ 的作用}

\item \textbf{actin filament的bundle和network形态分别是由什么蛋白介导的？}

\item \textbf{Parallel bundle 和 contractile bundle的区别是取决于什么以及是有什么形成的？}

\item \textbf{Myosin II的结构是什么？}

\item \textbf{肌节的结构是什么？}

\item \textbf{平滑肌的相应Ca2+信号进而产生收缩的机理是什么？}

\item \textbf{$\alpha$-tubulin 和 beta-tubulin本质的差别是什么？}

\item \textbf{如果microtubules丢掉了GTP cap会发生什么？}

\item \textbf{$\gamma$-tubulin的功能是什么}

\item \textbf{Tubulin-Sequestering and Microtubule-Severing Proteins功能分别是什么？}

\item \textbf{kinesin和dyneins的方向分别是什么？}

\item \textbf{Dynein attach to membrane enclosed organelles依靠的蛋白是什么？}

\item \textbf{Lissencephaly的名字是什么，为什么会导致这个？}

\item \textbf{Dynein、linker protein导致鞭毛波动的基本机制？}

\item \textbf{Plectin、SUN-KASH的作用是什么？}

\item \textbf{Rac-GTP和Rho-GTP的功能分别是什么？}
...
\section*{细胞膜与膜转运}
\begin{enumerate}
\item \textbf{Cell membrane function是什么？（一共有四个）}

\item \textbf{细胞膜主要由哪三大成分组成？}

\item \textbf{Phospholipid 里面最主要的是哪个成分？}

\item \textbf{胆固醇的主要作用是什么，fill 了因为什么而形成的gap?}

\item \textbf{膜脂在脂双层中的运动模式以及频率？}

\item \textbf{membrane proteins有哪四种？}

\item \textbf{参与信号蛋白膜定位的两类主要脂质锚是什么？}

\item \textbf{水通道蛋白的结构是怎样的？}

\item \textbf{transmembrane domains 的结构一般是什么？}

\item \textbf{hydropathy plots怎么看？}

\item \textbf{glycosylated的位置是哪里}

\item \textbf{nanodisc的意义和形成过程是怎样的？}

\item \textbf{什么蛋白必须需要detergent，而什么蛋白不需要？}

\item \textbf{Membrane-bending Proteins三种模式}

\item \textbf{Permeases是什么？}

\item \textbf{transporter具有三种状态是什么？}

\item \textbf{active transport的三种途径分别是什么？}

\item \textbf{inverted repeats的意义是什么？}

\item \textbf{Anti-diabetic与Anti-depressant}

\item \textbf{ATP-Driven Pumps有哪三种，分别都是在什么地方起作用}

\item \textbf{bacteria的膜内外转运的相互配合}

\item \textbf{F1F0 ATP synthase 的机理是什么？}

\item \textbf{Bacterial Cells Against Extreme Osmotic Pressures依靠的是哪一种channel？}

\item \textbf{钾离子通道蛋白的结构，以及它具有的三种状态？}

\item \textbf{髓鞘的英文是什么？}

\item \textbf{乙酰胆碱受体的结构和机制}

\item \textbf{Neuromuscular Transmission的激活过程（一直到t-tubule）}

\item \textbf{long-term potentiation的建立以及NMDA和AMPA的调控是怎样的？}
...
\section*{细胞器与蛋白分选}
\begin{enumerate}
\item \textbf{symbiotics的机制是什么，以及细胞核和内膜系统的形成？}

\item \textbf{蛋白质的三种不同的transport mechanisms，以及画出胞内转运机制以及方向图？}

\item \textbf{细胞核的内膜外膜}

\item \textbf{细胞核的import和export的具体机制}

\item \textbf{线粒体转运涉及哪些蛋白，这些蛋白的功能分别是什么？}

\item \textbf{蛋白质转运进类囊体需要几部分信号肽？}

\item \textbf{过氧化物酶体的三种主要功能是什么？}

\item \textbf{Adrenoleukodystrophy是什么？}

\item \textbf{进入过氧化物酶体的信号肽在哪里？}

\item \textbf{在肝脏的光滑内质网的功能是什么？}

\item \textbf{Rough ER和Smooth ER在结构上的区别是什么？}

\item \textbf{signal-recognition particle(SRP)的形成机制是什么？}

\item \textbf{signal peptide对于translocator的作用}

\item \textbf{Post-translational translocation以及BiP在其中的作用？}

\item \textbf{形成single pass transmembrane protein的两次识别分别是什么？}

\item \textbf{如何实现多跨膜区域？}

\item \textbf{蛋白质的插入方向是如何选择的？}

\item \textbf{Tail-anchored Protein的锚定机制是什么？(有三个相关蛋白和一个complex)}

\item \textbf{glycosylated的蛋白的修饰位点在哪里？}

\item \textbf{折叠失败的蛋白，不再尝试修复，而是被“拉回细胞质并降解”的过程？}
...
\begin{enumerate}
\item \textbf{vesicle function是哪三点？}

\item \textbf{clathrin蛋白包被的囊泡结构是什么？}

\item \textbf{COPII adaptor coat proteins是什么，他们有什么特点?}

\item \textbf{LIPID SIGNALS的机制是什么?}

\item \textbf{recognizing the correct target membrane的两步骤？}

\item \textbf{Rab的活跃和非活跃状态是由什么决定的？以及在活跃和非活跃状态下都有什么特点？}

\item \textbf{SNARE的两种分别有什么特点，他们的解离需要什么？}

\item \textbf{ER到Golgi的正向运输和反向运输分别依靠的是什么包被蛋白？}

\item \textbf{为什么需要retrieval pathway？}

\item \textbf{Golgi的层级特点，大概每一层的功能？}

\item \textbf{Golgi主要发生哪一种糖基化？}

\item \textbf{蛋白质糖基化的意义？}

\item \textbf{怎么理解lysosome的hetergenous？}

\item \textbf{在植物和fungus里面什么承担了lysosome的功能？}

\item \textbf{在高尔基体里M6P pathway的标记和分选}

\item \textbf{GlcNAc phosphotransferase标记过程是怎样的？}

\item \textbf{Endocytosis、Phagocytosis、Macropinocytosis都是什么？}

\item \textbf{Autophagy的两种形式以及出现的原因和情况，吞噬过程中形成的结构是什么（一共五步）？}
...
\begin{enumerate}
\item \textbf{pinocytosis和phagocytosis的区别是什么？}

\item \textbf{caveolae（小窝）介导的内吞路径是什么？}

\item \textbf{Macropinocytosis与其他方式的不同之处有哪些？}

\item \textbf{atherosclerotic plaques的产生原因？}

\item \textbf{胆固醇一般会存在在哪种particle里面？}

\item \textbf{ESCRT Protein Complexes的主要功能是什么， 实现这个功能的主要机制是什么？}

\item \textbf{Recycling Endosomes Regulate Plasma Membrane Composition的一个最典型的例子是什么？}

\item \textbf{Trans Golgi Network (TGN)出来有哪三条路径？}

\item \textbf{cargo concentration的机制是什么？}

\item \textbf{Inducible的分泌囊泡是如何实现效果的？（一共五步）}
...
\begin{enumerate}
\item \textbf{核纤层（nuclear lamina）的结构蛋白——lamins 的分类与类型是什么？}

\item \textbf{核型分析（karyotyping）能检测哪些类型的染色体异常？}

\item \textbf{为什么DNA序列本身会影响核小体（nucleosome）的形成位置？}

\item \textbf{H1（连接组蛋白）的作用是什么？}

\item \textbf{ATP依赖的染色质重塑复合体有什么作用？}

\item \textbf{酵母着丝粒为什么说是由特殊核小体定义的？}

\item \textbf{异染色质（heterochromatin）为什么能self-propagating？}

\item \textbf{研究染色体三维结构（3D genome）的方法有哪些？}

\item \textbf{多线染色体（polytene chromosomes）的chromocenter是什么？}

\item \textbf{gene duplication 的意义是什么？}

\item \textbf{真核细胞的三种RNA聚合酶（Pol I / II / III）分别转录什么？}

\item \textbf{topoisomerase 为什么重要？}

\item \textbf{真核mRNA最先发生的加工步骤是什么？}

\item \textbf{真核mRNA的3'端是如何形成的？}

\item \textbf{DNA looping 在细菌转录激活中的意义是什么？}

\item \textbf{什么是Transcriptional synergy？}

\item \textbf{Insulator（绝缘子）DNA序列的作用是什么？}

\item \textbf{什么是cell memory（细胞记忆）？}

\item \textbf{Genomic imprinting是什么？}

\item \textbf{X 染色体失活（XCI）是什么？}

\item \textbf{同一个基因如何通过APA决定蛋白是膜型还是分泌型？}
...
\subsection*{细胞与模型生物}
\begin{enumerate}
\item \textbf{为什么说细胞是生命的基本单位，这句话在实验生物学里真正意味着什么？}

\item \textbf{为什么rRNA序列特别适合用来构建“生命之树”？}

\item \textbf{为什么说古菌在分子层面上往往更接近真核生物，而不是更接近细菌？}

\item \textbf{为什么不同细胞能有完全不同的形态和功能，但仍然拥有相同的DNA？}

\item \textbf{为什么模式生物在细胞生物学里如此重要？}

\item \textbf{为什么酵母既适合研究细胞周期，也适合研究自噬？}
...
\subsection*{显微与实验技术}
\begin{enumerate}
\item \textbf{为什么分辨率比放大倍数更能决定显微镜“有用不好用”？}

\item \textbf{相差显微镜为什么特别适合观察活细胞？}

\item \textbf{荧光显微镜相比普通光学显微镜最大的概念提升是什么？}

\item \textbf{FRAP实验最适合回答什么类型的问题？}

\item \textbf{为什么细胞融合实验能证明膜蛋白会在膜平面内扩散？}

\item \textbf{为什么SDS-PAGE能按分子量分离蛋白？}

\item \textbf{二维电泳相比普通SDS-PAGE多解决了什么问题？}

\item \textbf{为什么X射线晶体学和冷冻电镜都属于“结构生物学”，但面对的问题并不完全相同？}
...
\begin{enumerate}
\item \textbf{为什么“保守序列”常常能提示功能重要性？}

\item \textbf{为什么基因敲除、过表达和定位实验往往要结合起来看？}

\item \textbf{为什么RNA水平和蛋白水平不一定一致？}

\item \textbf{为什么替代剪接能显著提高真核细胞的功能复杂性？}

\item \textbf{为什么microRNA更像“微调器”而不是简单的开关？}
...
\begin{enumerate}
\item \textbf{为什么核仁通常被视为最典型的nuclear body？}

\item \textbf{核纤层除了“支撑细胞核”之外还有什么更深层的意义？}

\item \textbf{为什么说DNA双螺旋结构天然就暗示了遗传复制机制？}

\item \textbf{为什么真核DNA必须包装成染色体，而不能“裸奔”？}

\item \textbf{为什么nucleosome既帮助压缩DNA，又会给转录带来阻碍？}

\item \textbf{ATP-dependent chromatin remodeling complex 的真正作用逻辑是什么？}

\item \textbf{为什么histone modification 常常被说成是一种“语言”或“代码”？}

\item \textbf{为什么heterochromatin 能自我传播？}

\item \textbf{为什么centromere 的身份不能只用DNA序列来解释？}

\item \textbf{为什么说染色体高级结构是“fluid and hierarchical”的？}

\item \textbf{polytene chromosome 为什么对研究染色体结构特别有用？}

\item \textbf{为什么基因表达活跃区域常会从染色体territory中伸出来？}
...
\subsection*{转录与转录调控}
\begin{enumerate}
\item \textbf{RNA相对DNA最重要的化学差异为什么会带来巨大的结构差异？}

\item \textbf{为什么细菌和真核生物的转录起始复杂度差异这么大？}

\item \textbf{为什么RNA polymerase II 的CTD如此重要？}

\item \textbf{为什么真核转录常常和RNA加工同步发生？}

\item \textbf{为什么alternative splicing 是细胞特异性的重要来源？}

\item \textbf{为什么eukaryotic gene regulation 常常强调 combinatorial control？}

\item \textbf{为什么转录激活常常是“协同”的，而不是简单相加？}

\item \textbf{为什么细胞记忆能在没有DNA序列改变的情况下长期存在？}

\item \textbf{X染色体失活为什么是研究表观遗传的经典模型？}
...
\begin{enumerate}
\item \textbf{为什么nuclear lamina 的改变不仅会影响细胞核形状，还会影响基因表达？}

\item \textbf{为什么karyotyping 适合发现大片段异常，却不适合发现点突变？}

\item \textbf{为什么说核小体定位既受DNA序列影响，又不能完全由DNA序列决定？}

\item \textbf{H1 为什么会让染色质更“高级压缩”，而不只是多放一个组蛋白？}

\item \textbf{为什么染色质重塑复合体对转录调控特别关键？}

\item \textbf{为什么CENP-A 核小体可以被理解为着丝粒身份的“表观遗传标记”？}

\item \textbf{为什么heterochromatin 的reader-writer 机制会天然导致“边界扩散”的风险？}

\item \textbf{为什么研究3D genome 需要同时用Hi-C 和 chromosome tracing 这两类方法？}

\item \textbf{为什么polytene chromosome 的chromocenter 有助于理解异染色质的组织作用？}

\item \textbf{为什么gene duplication 被看作演化创新的安全机制？}

\item \textbf{为什么真核细胞需要三种RNA polymerase，而不是一个polymerase做完所有事？}

\item \textbf{为什么topoisomerase 在高转录活性区域尤其重要？}

\item \textbf{为什么5' capping 会在转录刚开始不久就发生，而不是等mRNA做完再统一处理？}

\item \textbf{为什么真核mRNA 的3'端形成要靠“切割+poly(A)”而不是直接照着DNA模板转完？}

\item \textbf{为什么DNA looping 能显著增强转录调控的灵活性？}

\item \textbf{为什么transcriptional synergy 经常意味着多个调控因子不是独立工作的？}

\item \textbf{为什么insulator 对复杂基因组尤其重要？}

\item \textbf{为什么positive feedback 是产生cell memory 的经典回路结构？}

\item \textbf{为什么genomic imprinting 会被认为是“谁给的等位基因很重要”？}

\item \textbf{为什么XCI 是 dosage compensation，而不是简单关掉一条染色体？}

\item \textbf{为什么APA 可以改变蛋白最终去向，而不仅仅是改变mRNA长度？}
...
\subsection*{细胞骨架机制题}
\begin{enumerate}
\item \textbf{为什么actin filament 特别适合驱动细胞边缘快速形变，而微管不适合承担这个角色？}

\item \textbf{为什么actin nucleation 会成为聚合反应的限速步骤？}

\item \textbf{为什么ATP hydrolysis 会让actin filament 出现 treadmilling？}

\item \textbf{formin 和 Arp2/3 的分工为什么能直接决定细胞边缘长什么样？}

\item \textbf{为什么肌球蛋白II必须形成bipolar thick filament 才特别适合做收缩机器？}

\item \textbf{为什么微管的动态不稳定性对有丝分裂尤其关键？}

\item \textbf{为什么中间丝被称为“机械韧性系统”，而不是“运输系统”？}

\item \textbf{为什么上皮组织中特别依赖中间丝和连接结构的整合？}
...
\begin{enumerate}
\item \textbf{为什么说膜的“流动性”不是一个装饰性性质，而是决定功能的核心参数？}

\item \textbf{为什么脂双层本身就足以形成屏障，但远不足以形成“活的膜”？}

\item \textbf{为什么通道比转运体快得多，但在选择性控制上反而更依赖“门控”？}

\item \textbf{为什么Na$^+$/K$^+$ pump 对神经兴奋性如此重要，即使它不直接产生动作电位？}

\item \textbf{为什么K$^+$ channel 能高效区分K$^+$和更小的Na$^+$？}

\item \textbf{为什么myelination 会显著提高神经传导速度？}

\item \textbf{为什么NMDA receptor 能充当“巧合检测器”？}
...
\begin{enumerate}
\item \textbf{为什么所有蛋白都在胞质核糖体上起始翻译，却还能被送往完全不同的细胞器？}

\item \textbf{为什么核孔运输和线粒体/ER转运在概念上必须区分开？}

\item \textbf{为什么线粒体导入常常需要膜电位？}

\item \textbf{为什么过氧化物酶体在代谢病中经常与神经系统病变联系在一起？}

\item \textbf{为什么粗面内质网常被视为“分泌途径的入口站”？}

\item \textbf{为什么SRP 的存在能提高蛋白分选准确性？}

\item \textbf{为什么BiP 既是折叠伴侣，也是转运机器的一部分？}

\item \textbf{为什么ER质量控制必须同时具备“再尝试折叠”和“最终降解”两套机制？}

\item \textbf{为什么UPR 不能只做一件事，而要同时“增加折叠能力”和“减少新负担”？}
...
\begin{enumerate}
\item \textbf{为什么vesicle transport 常被说成是“保持细胞区室身份”的系统，而不只是送货系统？}

\item \textbf{为什么coat protein 不能单独决定囊泡命运？}

\item \textbf{为什么phosphoinositide 可以被理解为“膜地址码”？}

\item \textbf{为什么Rab和SNARE要分成两步，而不让SNARE直接完成所有特异性识别？}

\item \textbf{为什么ER需要retrieval pathway，而不能简单地“只让该出去的出去”？}

\item \textbf{为什么Golgi 特别适合作为糖基化加工中心？}

\item \textbf{为什么lysosome 被称为异质性细胞器而不是单一囊泡？}

\item \textbf{为什么M6P 标记必须在Golgi 里而不是在溶酶体里完成？}

\item \textbf{为什么自噬既是“生存机制”，又可能与细胞死亡相关？}

\item \textbf{为什么选择性自噬比非选择性自噬更能体现细胞“主动管理质量”的能力？}

\item \textbf{为什么受体介导内吞和macropinocytosis 在生理意义上非常不同？}

\item \textbf{为什么ESCRT 在膜生物学里非常特别？}
...
\newpage
\addcontentsline{toc}{section}{答案}
\section*{答案}
\subsection*{细胞骨架}
\begin{enumerate}
...
\item \textbf{将FtsZ、MreB、ParM与Crescentin进行一一对应}：FtsZ 对应 \textbf{tubulin-like}，参与细菌胞质分裂并形成 Z-ring；
...
\subsection*{第二部分：灵活问答}
\subsubsection*{细胞与模型生物}
\begin{enumerate}
